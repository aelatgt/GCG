...
import '../components/add-morph-object.js'
...
// morph.setAttribute("add-morph-object","")
// morph.setAttribute("position",{x: 2, y:3, z:0})
// APP.scene.appendChild(morph)


const c1 = document.createElement("a-cylinder")
c1.setAttribute("id","1")
c1.setAttribute("position",{x: 15, y:0.5, z:10})
...
c12.setAttribute("position",{x: 15, y:0, z:10})
c12.setAttribute("height",0.5)
...
c2.setAttribute("position",{x: 9, y:0.5, z:10})
...
c22.setAttribute("position",{x: 9, y:0, z:10})
c22.setAttribute("height",0.5)
...
c3.setAttribute("position",{x: 3, y:0.5, z:10})
...
c32.setAttribute("position",{x: 3, y:0, z:10})
c32.setAttribute("height",0.5)
...
c4.setAttribute("position",{x: -3, y:0.5, z:10})
...
c42.setAttribute("position",{x: -3, y:0, z:10})
c42.setAttribute("height",0.5)
...
c5.setAttribute("position",{x: -9, y:0.5, z:10})
...
c52.setAttribute("position",{x: -9, y:0, z:10})
c52.setAttribute("height",0.5)
...
c6.setAttribute("position",{x: -15, y:0.5, z:10})
...
c62.setAttribute("position",{x:-15, y:0, z:10})
c62.setAttribute("height",0.5)
