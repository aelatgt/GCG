...
AFRAME.registerComponent('update-morph', {
  ...
  tick: function () {
    ...
    if (x > 0 && z < (217 * x / 375) + (17 / 50)){
      path = "abstract and text"
      AFRAME.utils.entity.setComponentProperty(morphModel, "gltf-morph__text.value","0")
      AFRAME.utils.entity.setComponentProperty(morphModel, "gltf-morph__realistic.value","" + (abstract.distanceTo(this.player.position)/30))
    //morphing between abstract and reality
    } else if (x <= 0 && z < (-217 * x / 375) + (17 / 50)) {
      path = "abstract and reality"
      AFRAME.utils.entity.setComponentProperty(morphModel, "gltf-morph__realistic.value","0")
    ...
    //morphing between reality and text
      ...
      AFRAME.utils.entity.setComponentProperty(morphModel, "gltf-morph__realistic.value","" + (text.distanceTo(this.player.position)/30))
